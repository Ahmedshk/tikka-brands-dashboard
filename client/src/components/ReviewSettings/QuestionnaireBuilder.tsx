            ...
            return (
              <div key={q.id} className="border border-gray-100 rounded-lg bg-gray-50/50">
                ...
                >
                  ...
                  <span className="flex-1 text-sm text-primary truncate">{q.text || "(Untitled question)"}</span>
                  ...
                  <div className="px-4 pb-4 border-t border-gray-100 pt-3 space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-gray-500 mb-2">
                        Same file types as training modules. Files upload when you save Review Settings.
                      </p>
                      {saved.length > 0 || pending.length > 0 ? (
                        <ul className="space-y-2">
                          ...
                          {pending.map((pf) => (
                            <li
                              key={pf.id}
                              className="flex items-center gap-3 p-2 rounded-lg border border-amber-200 bg-amber-50/50"
                            >
                              {isImageFile(pf.file) ? (
                              ...
                              <span className="text-sm text-primary truncate min-w-0 flex-1" title={pf.file.name}>
                                {pf.file.name}
                                <span className="text-amber-700 text-xs ml-1">(pending upload)</span>
                              </span>
                              <div className="flex items-center gap-1 shrink-0">
                                <button
                                  type="button"
